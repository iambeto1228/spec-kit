...
```bash
uv tool install specify-cli --from git+https://github.com/iambeto1228/spec-kit.git
```
...
```bash
uv tool install specify-cli --force --from git+https://github.com/iambeto1228/spec-kit.git
```
...
| `--ai`                 | Option   | AI assistant to use: `claude`, `gemini`, `copilot`, `cursor-agent`, `qwen`, `opencode`, `codex`, `windsurf`, `kilocode`, `auggie`, `roo`, `codebuddy`, `trae`, or `q` |
